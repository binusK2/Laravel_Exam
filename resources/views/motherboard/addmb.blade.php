...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Tambah Motherboard') }}</div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-12">
                                ...
                                <form action="{{ route('motherboard.store') }}" method="POST"
                                    ...
                                    <div class="mb-3">
                                        <label for="name"
                                            class="col-md-4 col-form-label text-md-right">{{ __('Merk Motherboard') }}</label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="mb-3">
                                        <label for="name"
                                            class="col-md-4 col-form-label text-md-right">{{ __('Tipe Motherboard') }}</label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="col-md-12">
                                            <input id="harga" type="number"
                                                class="form-control @error('i_harga') is-invalid @enderror" name="harga"
                                    ...
                                    <div class="row flex-column flex-fill">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <a href="{{ route('motherboard.index') }}" class="btn btn-dark">Back</a>
