    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <h5 class="card-header">{{ __('Daftar Motherboard') }}</h5>
                <div class="card-body">
                    <div class="card-body">
                        <br>
                        @csrf
                        <div class="row justify-content-center">
                            <div class="col-md-12">
                                <div class="float-right">
                                    <a href="{{ route('motherboard.create') }}" class="btn btn-primary"><i
                                            class="fa fa-plus"></i>Tambah Motherboard</a>
                                </div>
                            </div>
                            <br>
                            <br>
                                                    ...
                                                    {{-- <div class="btn-group"> --}}
                                                        <center>
                                                            <div class="action_btn">
                                                                <a href="{{ route('motherboard.edit', $i->id )}}"
                                                                    class="btn btn-success">Edit</a>
                                                            </div>
                                                            <form action="{{ route('motherboard.destroy', $i->id)}}"
                                                                method="post">
                                                                @csrf
                                                                @method('DELETE')
