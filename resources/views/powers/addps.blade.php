...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Tambah Power Supply') }}</div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-12">
                                ...
                                <form action="{{ route('ps.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        <label for="name"
                                            class="col-md-4 col-form-label text-md-right">{{ __('Merk Power Supply') }}</label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="mb-3">
                                        <label for="name"
                                            class="col-md-4 col-form-label text-md-right">{{ __('Tipe Power Supply') }}</label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="row flex-column flex-fill">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <a href="{{ route('ps.index') }}" class="btn btn-dark">Back</a>
