...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Tambah Daftar VGA') }}</div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-12">
                                ...
                                @endif
                                <form action="{{ route('vga.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="name"
                                            class="col-md-4 col-form-label text-md-right">{{ __('Merk VGA') }}</label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="mb-3">
                                        <label for="name"
                                            class="col-md-4 col-form-label text-md-right">{{ __('Tipe VGA') }}</label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="row flex-column flex-fill">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <a href="{{ route('vga.index') }}" class="btn btn-dark">Back</a>
