...
<body class="antialiased">
    <div
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            <a href="{{ url('/home') }}" class="text-lg text-gray-700 dark:text-gray-500">Home</a>
            @else
            <a href="{{ route('login') }}" class="text-lg text-gray-700 dark:text-gray-500">Log in</a>

            @if (Route::has('register'))
            <a href="{{ route('register') }}"
                class="ml-4 text-lg text-gray-700 dark:text-gray-500">Register</a>
            @endif
